...
def transcribe_audio(stop_key='esc'):
    """Record audio until stop_key is pressed and return transcribed text"""
    # Initialize variables
    audio_data = []
    sample_rate = 16000  # Changed to 16kHz for better compatibility with AssemblyAI
    should_stop = False
    ...
    stream = sd.InputStream(
        ...
        channels=1,
        dtype=np.int16,  # Specify data type explicitly
    ...
    try:
        ...
        aai.settings.api_key = "03cda7379f1f4230a7a6ef080a09b86e"
        ...
        print("\n🔄 Transcribing audio...")
        transcript = transcriber.transcribe(byte_io.getvalue())
